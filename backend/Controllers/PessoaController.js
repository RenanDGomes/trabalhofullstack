...
exports.createPessoa = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Erro ao criar pessoa física no sistema', details: error.message});
    }
};
...
exports.getAllPessoas = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Erro ao buscar pessoas no sistema', details: error.message});
    }
};
...
exports.updatePessoa = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Erro ao atualizar dados da pessoa física', details: error.message });
    }
};
